...
STYLE_GEOMETRY_STRENGTH=0.90
STYLE_OPACITY_STRENGTH=0.45
...
CUDA_VISIBLE_DEVICES=$device "$PYTHON_BIN" -m lam.launch infer.lam --config $TRAIN_CONFIG \
        ...
        style_image_path=$STYLE_IMAGE_PATH style_strength=$STYLE_STRENGTH \
        style_internal_appearance_strength=$STYLE_INTERNAL_APPEARANCE_STRENGTH \
        style_geometry_strength=$STYLE_GEOMETRY_STRENGTH style_opacity_strength=$STYLE_OPACITY_STRENGTH \
        style_track_geometry=$STYLE_TRACK_GEOMETRY \

...
class VideoDataset(Dataset):
    ...
    def match_sequences(self):
        ...
        # An exact directory match wins outright: the prefix glob below treats
        # sequence '10' as ambiguous whenever a sibling like '100' exists, which
        # makes callers that key sequences off an image stem fail on names that
        # merely prefix another one.
        exact_path = self.cfg.root_folder / self.cfg.sequence
